// глава 15 упр 4.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
try
{
	...
	Function f2(cos, r_min, r_max, center, 400, 20, 20);
	f2.set_color(Color::blue);
	//win.attach(f2);

	Function f3(sin, r_min, r_max, center, 400, 20, 20);
	f3.set_color(Color::blue);
	//win.attach(f3);

	Function f4(sin_plus_cos, r_min, r_max, center, 400, 20, 20);
	f4.set_color(Color::blue);
	win.attach(f4);

	Function f5(dsin_plus_dcos, r_min, r_max, center, 400, 20, 20);
	f5.set_color(Color::blue);
	win.attach(f5);

	Function f6(sin_multiply_cos, r_min, r_max, center, 400, 20, 20);
