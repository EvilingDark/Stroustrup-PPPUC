// глава 4,15.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
//программа ищет n простых чисел по алгоритму решето эратосфена
int main()
{
	...
	cout << "Найдено " << prime_2.size() << " простых чисел\n";
